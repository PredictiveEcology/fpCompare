...
This outlines how to propose a change to fpCompare. For a detailed
...
- Fork the package and clone onto your computer. If you haven’t done
  ...
  `usethis::create_from_github("PredictiveEcology/fpCompare", fork = TRUE)`.
...
Code of
Conduct](https://fpcompare.predictiveecology.org/CODE_OF_CONDUCT.md). By
